#!/usr/bin/env python3
"""
hc11_disassembler.py — UNIVERSAL BACKUP
=======================================
Motorola 68HC11 Disassembler — Universal Version

This is a frozen backup of hc11_disassembler_060a_enhanced_v1.py (v2.2.0).
The specialized version (060a_enhanced_v1) is the actively developed file.
This copy is kept as a universal/generic starting point for future adaptation
to other HC11 ECU binaries beyond the VY V6 $060A.

Supported binaries (via --bank flag or auto-detect):
  Enhanced v1.0a  → XDF v2.09b-beta (2234 defs) or v2.09a (1757 defs)
  Enhanced v1.1a  → XDF v2.04 (The1's spark cut version)
  STOCK 92118883  → XDF v2.62
...
- TunerPro XDF integration: loads calibration definitions as labels
- Bank-split support: --bank bank1|bank2|bank3|full + auto-detect from filename
...
HISTORY:
- Nov 2025:  Initial version with ~80 opcodes
- Jan 2026:  Merged complete + enhanced into single tool
- Jan 20:    v2.0 — XDF auto-detection, progress tracking, full register map
- Feb 14:    v2.1 — Renamed to hc11_disassembler_060a_enhanced_v1.py
- Feb 14:    v2.2 — Bank-split support, offset_to_cpu_addr(), --bank CLI flag
- Feb 14:    This file frozen as universal backup of v2.2.0

Author: KingAI Automotive Research
License: MIT
Version: 2.2.0-universal-backup
"""
